...
// Note this was moved from ParaView to PHASTA for easier building.
// There it was called PhastaAdaptor.cxx.

#include "CatalystAdaptorAPIMangling.h"
